  ...
  try {
    ...
    if (!sheet) {
      ...
      sheet.getRange(1, 1, 1, 6).setValues([
        ['User ID', 'Completion Time', 'Time Taken (seconds)', 'Timestamp', 'Date', 'Time of Day']
      ]);
    }
    ...
    return ContentService
      .createTextOutput(JSON.stringify({success: true, message: 'Submission recorded successfully'}))
